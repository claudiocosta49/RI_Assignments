...
public class Indexer {
    ...
    public Indexer(int blockSize, int memorySize, int blockNumber, List<Document> docList, int N) {
        this.vocabSize = 0;
    ...
    private void sortAndWriteBlock(Map<String, Map<String, List<Integer>>> dict, String paperId) {
    ...
    public void mergeAllBlocks(){
		...
		writeMergedDict(mergedBlocks);

    }
    public static List<String> mergeBlocks(Map<String,Map<String,List<Integer>>> map1,Map<String,Map<String,List<Integer>>> map2){
	...
	private void writeMergedDict(Map<String,Map<String, List<Integer>>> dict){
